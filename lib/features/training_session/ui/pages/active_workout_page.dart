...
import 'package:reforge/features/training_session/ui/widgets/active_workout_page/active_workout_loader.dart';
import 'package:reforge/features/training_session/ui/widgets/dynamic_workout_form.dart';
import 'package:reforge/features/training_session/ui/widgets/exercise_results/previus_exercise_result_list_tile.dart';
import 'package:reforge/features/training_session/ui/widgets/workout_section.dart';
                      ...
                      children: [
                        ...
                        if (exerciseDetails.metrics.any((m) => m == WorkoutMetric.distance)) ...[
                          ...
                          SecondaryButton(
                            text: 'Start Running',
                            onPressed: () async {
                              await const StartRunningPageRoute().push<void>(context).then((_) {});
                            },
                          ),
                          const SizedBox(height: 8),
                        ],
